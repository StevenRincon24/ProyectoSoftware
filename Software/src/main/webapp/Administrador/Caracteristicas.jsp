	...
	<jsp:include page="../Menu/MenuAdministrador.jsp"/>
			...
			<div class="col-xl-12">
				...
				<div class="col-4">
		  		...
		  		<div class="col-4">
					...
					<div class="invalid-feedback">¡Debe seleccionar una de las opciones!</div>
				  </div>
				</form>
				...
				<div class="containerCaracterPage1">
			  		...
			  		<div class="col-4">
						...
						<div class="input-group mb-3">
							<select class="form-select" aria-label="Seleccione" required>
							  ...
							  <option value="NoAcademica">No Académica</option>
							</select>
							<div class="invalid-feedback">¡Debe seleccionar una de las opciones!</div>
						</div>
		  			</div>
		   		<div class="col-4">
			  		<label for="inputPeriodo" class="form-label">Periodo</label>
						<div class="input-group mb-3">
							<select class="form-select" aria-label="Seleccione" required="required">
							  <option selected>Seleccione</option>
							  <option value="Periodo1">I Periodo</option>
							  <option value="Periodo2">II Periodo</option>
							</select>
							<div class="invalid-feedback">¡Debe seleccionar un periodo!</div>
						</div>
		  		</div>
		  	 	<div class="col-4">
			  		<label for="inputPeriodo" class="form-label">Cantidad de Estudiantes</label>
						<div class="input-group mb-3">
							<input type="number" class="form-control" type="number" placeholder="Número" aria-label="Numero" aria-describedby="basic-addon1" value="" required="required">
						<div class="invalid-feedback">¡Debe escribir la cantidad de estudiantes!</div>
						</div>
		  		</div>
						</div>
				<div class="row justify-content-center" style="margin-top: 30px">
				...
				<div class="col-4">
			  		<label for="inputPeriodo" class="form-label">Número de matriculados</label>
						<div class="input-group mb-3">
							<input type="number" class="form-control" type="number" placeholder="Número" aria-label="Numero" aria-describedby="basic-addon1" value="" required="required">
						<div class="invalid-feedback">¡Debe escribir la cantidad de estudiantes matriculados!</div>
						</div>
		  	</div>
			<div class="col-4">
		...
		<div class="containerCaracterPage2">
				<div class="row justify-content-center" style="margin-top: 30px">
			 		<div class="col-6">
						...
						<textarea class="form-control" placeholder="Escriba lo relacionado con el concepto" id="TextareaConcepto" style="height: 200px" value="" required="required"></textarea>
						<div class="invalid-feedback">¡Debe escribir el concepto!</div>
			  		</div>
			   		<div class="col-6">
			  		<label for="inputTipo" class="form-label">Evidencia</label>
					<textarea class="form-control" placeholder="Escriba lo relacionado con la evidencia" id="TextareaEvidencia" style="height: 200px" required="required"></textarea>
					<div class="invalid-feedback">¡Debe escribir la evidencia!</div>
		  		</div>
			</div>
		<div class="row justify-content-center" style="margin-top: 30px">
			<div class="col-4">
			  <label for="inputCalificacion" class="form-label">Calificación</label>
				<div class="input-group mb-3">
					<input type="number" class="form-control" type="number" placeholder="Número" aria-label="Numero" aria-describedby="basic-addon1" value="" required="required">
					<div class="invalid-feedback">¡Debe escribir la calificación!</div>
				</div>
		  	</div>
		   ...
		   <div class="col-4">
			  <label for="inputPeriodoCalidad" class="form-label">Periodo</label>
				<div class="input-group mb-3">
					...
					<div class="invalid-feedback">¡Debe seleccionar uno de los periodos!</div>
				</div>
		  	</div>
		  	 <div class="col-4">
			  <label for="inputInscritosCalidad" class="form-label">Inscritos</label>
				<div class="input-group mb-3">
					<input type="number" class="form-control" type="number" placeholder="Número" aria-label="Numero" aria-describedby="basic-addon1" value="" required="required">
						<div class="invalid-feedback">¡Debe escribir la cantidad de estudiantes inscritos!</div>
				</div>
		  	</div>
		</div>
		<div class="row justify-content-center" style="margin-top: 30px">
			<div class="col-4">
				<label for="inputAdmitidosCalidad" class="form-label">Admitidos</label>
					<div class="input-group mb-3">
						<input type="number" class="form-control" type="number" placeholder="Número" aria-label="Numero" aria-describedby="basic-addon1" value="" required="required">
						<div class="invalid-feedback">¡Debe escribir la cantidad de estudiantes admitidos!</div>
					</div>
			</div>
			<div class="col-4">
		...
		<form class="needs-validation" novalidate>
		 <div class="containerCalidadPage2">
			<div class="row justify-content-center" style="margin-top: 30px">
			 	<div class="col-6">
			  		<label for="inputTipo" class="form-label">Concepto</label>
					<textarea class="form-control" placeholder="Escriba lo relacionado con el concepto" id="TextareaConceptoCalidad" style="height: 200px" value="" required="required"></textarea>
						<div class="invalid-feedback">¡Debe escribir el concepto!</div>
		  		</div>
		   		<div class="col-6">
			  		<label for="inputTipo" class="form-label">Evidencia</label>
					<textarea class="form-control" placeholder="Escriba lo relacionado con la evidencia" id="TextareaEvidenciaCalidad" style="height: 200px" value="" required="required"></textarea>
						<div class="invalid-feedback">¡Debe escribir la evidencia!</div>
		  		</div>
			</div>
		<div class="row justify-content-center" style="margin-top: 30px">
		  ...
		  <div class="row justify-content-center" style="margin-top: 30px">
			  ...
			  <label for="inputAccionActividad" class="form-label">Linea de Acción</label>
				<div class="input-group mb-3">
					...
					<div class="invalid-feedback">¡Debe seleccionar uno de las lineas de acción!</div>
				</div>
		  	</div>
		   <div class="col-4">
			  <label for="inputLineaActividad" class="form-label">Motivo línea de acción</label>
				<div class="input-group mb-3">
					...
					<div class="invalid-feedback">¡Debe seleccionar uno de los motivos por lineas de acción!</div>
				</div>
		  	</div>
		  	 <div class="col-4">
			  <label for="inputAnioActividad" class="form-label">Año</label>
				<div class="input-group mb-3">
					...
					<div class="invalid-feedback">¡Debe seleccionar uno de los años!</div>
				</div>
		  	</div>
		</div>
		<div class="row justify-content-center" style="margin-top: 30px">
			<div class="col-4">
				<label for="inputUsuariosActividad" class="form-label">Usuarios</label>
					<div class="input-group mb-3">
						<input type="number" class="form-control" type="number" placeholder="Número" aria-label="Numero" aria-describedby="basic-addon1" value="" required="required">
					<div class="invalid-feedback">¡Debe escribir el número de usuarios!</div>
					</div>
			</div>
			<div class="col-4">
			  <label for="inputServiciosActividad" class="form-label">Servicios</label>
				<div class="input-group mb-3">
					<input type="number" class="form-control" type="number" placeholder="Número" aria-label="Numero" aria-describedby="basic-addon1" value="" required="required">
					<div class="invalid-feedback">¡Debe escribir el número de servicios!</div>
				</div>
		  	</div>
		</div>
		</div>
		...
		<div class="containerActividadPage2">
			<div class="row justify-content-center" style="margin-top: 30px">
			 	<div class="col-6">
			  		<label for="inputTipo" class="form-label">Concepto</label>
					<textarea class="form-control" placeholder="Escriba lo relacionado con el concepto" id="TextareaConceptoCalidad" style="height: 200px" required="required"></textarea>
						<div class="invalid-feedback">¡Debe escribir el concepto!</div>
		  		</div>
		   		<div class="col-6">
			  		<label for="inputTipo" class="form-label">Evidencia</label>
					<textarea class="form-control" placeholder="Escriba lo relacionado con la evidencia" id="TextareaEvidenciaCalidad" style="height: 200px" required="required"></textarea>
						<div class="invalid-feedback">¡Debe escribir la evidencia!</div>
		  		</div>
			</div>
		<div class="row justify-content-center" style="margin-top: 30px">
		  ...
		  <div class="row justify-content-center" style="margin-top: 30px">
		   ...
		   <div class="col-4">
			  ...
			  <label for="inputReintegrosReglamento" class="form-label">Cantidad de reintegros</label>
				<div class="input-group mb-3">
					<input type="number" class="form-control" type="number" placeholder="Número" aria-label="Numero" aria-describedby="basic-addon1" value="" required="required">
					<div class="invalid-feedback">¡Debe escribir el número de reintegros!</div>
				</div>
		  	</div>
		</div>
		<div class="row justify-content-center" style="margin-top: 30px">
			<div class="col-4">
				<label for="inputEgresadosReglamento" class="form-label">Cantidad de egresados</label>
					<div class="input-group mb-3">
						<input type="number" class="form-control" type="number" placeholder="Número" aria-label="Numero" aria-describedby="basic-addon1" value="" required="required">
					<div class="invalid-feedback">¡Debe escribir el número de egresados!</div>
					</div>
			</div>
		</div>
		</div>
		...
		<div class="col-2">
			<button type="submit" class="btn btn-warning" style="color: #ffffff">Guardar</button>
		</div>
		<div class="col-1">
